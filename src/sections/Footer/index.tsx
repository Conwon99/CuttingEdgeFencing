        ...
        <div className="box-border caret-transparent gap-x-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-6 md:gap-x-8 md:gap-y-8">
          ...
          <div className="box-border caret-transparent flex flex-col gap-y-4">
            ...
            <p className="text-white/80 text-sm box-border caret-transparent max-w-xs leading-relaxed">
              ...
              Fencing, tree care and landscaping specialists serving Perth, Dundee, Perthshire and surrounding areas. Trees, fences, gardens and outdoor spaces handled.
            ...
            <div className="box-border caret-transparent flex flex-col gap-3 mt-2">
              ...
              <div className="box-border caret-transparent flex gap-4 flex-wrap">
                ...
                <a
                  ...
                  href="https://www.facebook.com/cuttingedgeperth/"
                  ...
                  aria-label="Cutting Edge on Facebook"
          ...
          <div className="box-border caret-transparent flex flex-col gap-y-3">
            ...
            <details className="group box-border caret-transparent mt-2">
              ...
              <div className="box-border caret-transparent flex flex-col gap-y-2 mt-3 pl-3">
                ...
                <a href="/locations/perth/fencing-perth-dundee" className="text-white/60 text-xs box-border caret-transparent hover:text-[#16a34a] pl-3 transition-colors duration-300">Fencing in Perth</a>

                <a href="/locations/dundee/fencing-perth-dundee" className="text-white/60 text-xs box-border caret-transparent hover:text-[#16a34a] pl-3 transition-colors duration-300">Fencing in Dundee</a>

                <a href="/locations/perth/landscaping-perth-dundee" className="text-white/60 text-xs box-border caret-transparent hover:text-[#16a34a] pl-3 transition-colors duration-300">Landscaping in Perth</a>

                <a href="/locations/dundee/landscaping-perth-dundee" className="text-white/60 text-xs box-border caret-transparent hover:text-[#16a34a] pl-3 transition-colors duration-300">Landscaping in Dundee</a>
          ...
          <div className="box-border caret-transparent flex flex-col gap-y-3">
            ...
            <a href="mailto:cuttingedge.services@outlook.com" className="text-white/80 text-sm box-border caret-transparent hover:text-[#16a34a] hover:decoration-transparent transition-colors duration-300">

              cuttingedge.services@outlook.com
          ...
          <div className="box-border caret-transparent flex flex-col gap-y-3">
            ...
            <div className="box-border caret-transparent w-full h-48 rounded-lg overflow-hidden">
              ...
              <iframe
                ...
                src="https://www.google.com/maps?q=Cutting+Edge+Fencing+Tree+Care+Landscaping+Perth+Dundee&output=embed"
                ...
                title="Cutting Edge service area map"
            ...
            <div className="box-border caret-transparent flex flex-col gap-2 mt-2">
              ...
              <a
                ...
                href="https://www.google.com/maps/search/?api=1&query=Cutting+Edge+Fencing+Tree+Care+Landscaping+Perth+Dundee"
              ...
              >
                ...
                View Cutting Edge on Google Maps
            ...
            <p className="text-white/80 text-sm box-border caret-transparent mt-1">
              ...
              Serving Perth, Dundee & Perthshire
